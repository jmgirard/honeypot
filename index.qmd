...
<blockquote>
When would a researcher use an independent samples t-test and when would they use a dependent samples t-test? {{{< hp subs=1 >}}}Then provide one example of when each test would be appropriate. Your whole answer should be around three sentences.
</blockquote>
